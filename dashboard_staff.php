  ...
  <div class="md:hidden bg-forest-600 text-white p-3 flex items-center justify-between">
    ...
    <div class="md:ml-64 flex-1 flex flex-col min-h-screen w-full">
        ...
        <main class="flex-1 p-3 md:p-6 space-y-4 md:space-y-5 overflow-y-auto">
            ...
            <!-- Need Help -->
            <section class="animate-fade-up-4 bg-white rounded-2xl border border-slate-200 p-4 md:p-5">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div
                            class="w-10 h-10 rounded-xl bg-red-50 text-red-500 flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400 mt-1 leading-relaxed max-w-xl">
                                Found a problem with the system or something isn't working correctly?
                    ...
                    <button type="button" onclick="openReportModal()"
                        class="report-button w-full sm:w-auto bg-forest-600 hover:bg-forest-700 text-white text-[10px] font-semibold rounded-xl px-5 py-2.5 flex items-center justify-center gap-2">
    ...
    <div id="reportModal" class="fixed inset-0 z-50 hidden items-center justify-center modal-backdrop p-4">

        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-modal-in">

            <!-- Modal Header -->
            <div
                class="px-5 py-4 border-b border-slate-200 flex items-center justify-between sticky top-0 bg-white z-10">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400">
                            Send an issue to the administrator
                        </p>
                    </div>
                ...
                <button type="button" onclick="closeReportModal()"
                    class="w-8 h-8 rounded-lg hover:bg-slate-100 text-slate-400 hover:text-slate-600">
            ...
            <form id="reportForm" onsubmit="return submitReport(event)">
                ...
                <div class="p-5 space-y-4">
                    ...
                    <!-- Reporter -->
                    <div class="bg-forest-50 border border-forest-100 rounded-xl p-3">

                        <div class="flex items-center gap-3">

                            <div class="w-8 h-8 rounded-full bg-white text-forest-600 flex items-center justify-center">
                                <i class="fas fa-user text-xs"></i>
                            </div>

                            <div>
                                <p class="text-[10px] uppercase tracking-wider text-forest-500 font-semibold">
                                    Reporting Staff
                                </p>

                                <p class="text-[12px] font-semibold text-forest-700">
                                    Staff User
                                </p>

                                <p class="text-[10px] text-forest-500">
                                    MSWDO Staff · @staff
                                </p>
                            </div>
                    ...
                    <!-- Problem Type -->
                    <div>
                        <label for="problemType" class="field-label">
                            Problem Type
                        </label>

                        <select id="problemType" class="field" required>
                    ...
                    <!-- Affected Page -->
                    <div>
                        <label for="problemPage" class="field-label">
                            Affected Page
                        </label>

                        <input type="text" id="problemPage" class="field"
                            placeholder="e.g. AICS, Client Registration, Dashboard">
                    </div>

                    <!-- Subject -->
                    <div>
                        <label for="problemSubject" class="field-label">
                            Subject
                        </label>

                        <input type="text" id="problemSubject" class="field" placeholder="Briefly describe the issue"
                            required>
                    </div>

                    <!-- Description -->
                    <div>
                        <label for="problemDescription" class="field-label">
                            Problem Description
                        </label>

                        <textarea id="problemDescription" rows="5" class="field resize-none"
                            placeholder="Please explain what happened, what you were trying to do, and what you expected to happen."
                            required></textarea>
                    </div>

                    <!-- Priority -->
                    <div>
                        <label for="problemPriority" class="field-label">
                            Priority
                        </label>

                        <select id="problemPriority" class="field">
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-xl p-3">
                        ...
                        <p class="text-[10px] text-slate-500 leading-relaxed">
                            ...
                            <i class="fas fa-info-circle text-forest-500 mr-1"></i>

                            Your staff account information will be included with this report so the administrator knows
                ...
                <div class="px-5 py-4 border-t border-slate-200 flex justify-end gap-2">
                    ...
                    <button type="button" onclick="closeReportModal()"
                        class="text-[11px] font-semibold text-slate-600 border border-slate-200 rounded-lg px-4 py-2 hover:bg-slate-50">
                    ...
                    <button type="submit"
                        class="text-[11px] font-semibold text-white bg-forest-600 hover:bg-forest-700 rounded-lg px-5 py-2 flex items-center gap-2">
