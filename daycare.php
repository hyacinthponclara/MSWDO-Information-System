    ...
    <main class="p-6 overflow-y-auto">
      <div class="max-w-4xl mx-auto space-y-5">
        ...
        <div class="animate-fade-up">
          ...
          <p class="text-[13px] text-slate-500 mt-1">DSWD Assessment Tool for Day Care Centers &amp; Day Care Workers
            (LGU-Managed)</p>
        </div>
        ...
        <div class="animate-fade-up-1 bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div class="flex items-center gap-3 px-6 py-4 border-b border-slate-100 bg-slate-50/60">
            ...
            <div>
              <h2 class="text-[14px] font-semibold text-navy-600">Status of Application &amp; Source of Funds</h2>
            </div>
          </div>
          <div class="p-6 space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <div class="flex gap-3 mt-1">
                  <label class="flex items-center gap-2 text-[13px]"><input type="radio" name="appStatus"
                      class="accent-navy-600"> New Application</label>
                  <label class="flex items-center gap-2 text-[13px]"><input type="radio" name="appStatus"
                      class="accent-navy-600"> Renewal</label>
                </div>
              </div>
              <div>
                <label class="field-label req">Source of Funds</label>
                <div class="flex flex-wrap gap-2 mt-1">
                  <label class="flex items-center gap-1.5 text-[12px]"><input type="checkbox" class="accent-navy-600">
                    NGA</label>
                  <label class="flex items-center gap-1.5 text-[12px]"><input type="checkbox" class="accent-navy-600">
                    GOCC</label>
                  <label class="flex items-center gap-1.5 text-[12px]"><input type="checkbox" class="accent-navy-600">
            ...
            <div class="grid grid-cols-3 gap-4">
              ...
              <div><label class="field-label">Date of Issuance</label><input type="date" class="field"></div>
              <div><label class="field-label">Date of Expiration</label><input type="date" class="field"></div>
            </div>
          </div>
        </div>
        ...
        <div class="animate-fade-up-2 bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div class="flex items-center gap-3 px-6 py-4 border-b border-slate-100 bg-slate-50/60">
            ...
            <div>
              <h2 class="text-[14px] font-semibold text-navy-600">Day Care Center &amp; Worker Information</h2>
            </div>
          </div>
          <div class="p-6 space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div class="col-span-2"><label class="field-label req">Name of Day Care Center</label><input type="text"
                  class="field" placeholder="Official name"></div>
            </div>
            <div class="grid grid-cols-2 gap-4">
              <div class="col-span-2"><label class="field-label req">Address</label><input type="text" class="field"
                  placeholder="Full address"></div>
            </div>
            <div class="grid grid-cols-3 gap-4">
              <div><label class="field-label req">Date Established</label><input type="date" class="field"></div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div><label class="field-label req">Day Care Worker Name</label><input type="text" class="field"
            ...
            <div class="grid grid-cols-2 gap-4">
              <div><label class="field-label req">C/MSWDO ECCD Focal Person</label><input type="text" class="field"
                  placeholder="DCS Supervisor / Administrator"></div>
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div><label class="field-label">Registration &amp; License No.</label><input type="text" class="field"
        ...
        <div class="animate-fade-up-2 bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div class="flex items-center gap-3 px-6 py-4 border-b border-slate-100 bg-slate-50/60">
            ...
            <div>
              <h2 class="text-[14px] font-semibold text-navy-600">Area A: Advancement of Children's Growth &amp;
                Development</h2>
              <p class="text-[11px] text-slate-400">Assessment of Children · Health &amp; Nutrition · Curriculum ·
          ...
          <div class="p-6 space-y-4">
            ...
            <div>
              ...
              <div class="grid grid-cols-1 gap-2">
                ...
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Recording of one-on-one assessment tasks <span
                      class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
              </div>
            </div>
            ...
            <div class="pt-3 border-t border-slate-100">
              ...
              <p class="text-[11px] text-slate-500 mb-2 font-medium">A. Nutrition &amp; Feeding Practices</p>
              <div class="grid grid-cols-1 gap-2">
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                ...
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Food brought by Parents Committee members <span
                      class="score-badge bg-navy-400 text-white ml-2">2 pts</span></span></label>
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
              ...
              <p class="text-[11px] text-slate-500 mb-2 mt-3 font-medium">B. Health &amp; Sanitation Practices</p>
              <div class="grid grid-cols-1 gap-2">
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                ...
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Medications &amp; hazardous objects stored securely <span
                      class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
            ...
            <div class="pt-3 border-t border-slate-100">
              ...
              <div class="grid grid-cols-1 gap-2">
                ...
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Art materials from local/reusable sources <span
                      class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Unstructured materials (sand, water, clay) <span
                      class="score-badge bg-navy-400 text-white ml-2">2 pts</span></span></label>
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
            ...
            <div class="pt-3 border-t border-slate-100">
              <h3 class="text-[12px] font-semibold text-navy-600 mb-3 flex items-center gap-2"><i
                  class="fas fa-hand-holding-heart text-navy-400"></i> IV. Guidance &amp; Interactions</h3>
              <div class="grid grid-cols-1 gap-2">
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Learning activity areas provided (story, table games, arts, news
                    sharing) <span class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Science/discovery or music/movement area <span
                      class="score-badge bg-navy-400 text-white ml-2">2 pts</span></span></label>
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Learning areas defined by dividers/markers <span
                      class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                ...
                <label
                  class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                    type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                    class="text-[12px] text-slate-700">Outdoor play area available &amp; supervised <span
                      class="score-badge bg-navy-400 text-white ml-2">2 pts</span></span></label>
              </div>
            </div>
        ...
        <div class="animate-fade-up-3 bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div class="flex items-center gap-3 px-6 py-4 border-b border-slate-100 bg-slate-50/60">
            ...
            <div>
              <h2 class="text-[14px] font-semibold text-navy-600">Area B: Partnership with Families, Communities &amp;
                Local Government</h2>
            </div>
          </div>
          <div class="p-6 space-y-3">
            ...
            <div class="grid grid-cols-1 gap-2">
              ...
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Written menu info provided to parents monthly <span
                    class="score-badge bg-navy-400 text-white ml-2">2 pts</span></span></label>
            </div>
        ...
        <div class="animate-fade-up-4 bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div class="flex items-center gap-3 px-6 py-4 border-b border-slate-100 bg-slate-50/60">
            ...
            <div>
              <h2 class="text-[14px] font-semibold text-navy-600">Area D: Program Management &amp; Administration</h2>
            </div>
          </div>
          <div class="p-6 space-y-3">
            <div class="grid grid-cols-1 gap-2">
              ...
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Previous evaluation results used for planning <span
                    class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Annual budget for compensation, education, materials <span
                    class="score-badge bg-navy-400 text-white ml-2">2 pts</span></span></label>
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
              ...
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Written policies: assessment, records, child protection <span
                    class="score-badge bg-navy-600 text-white ml-2">3 pts</span></span></label>
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Annual evaluation of work &amp; financial plan <span
                    class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Complete accounting of receipts &amp; expenditures <span
                    class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
            </div>
          </div>
        </div>
        ...
        <div class="animate-fade-up-4 bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div class="flex items-center gap-3 px-6 py-4 border-b border-slate-100 bg-slate-50/60">
            ...
            <div>
              <h2 class="text-[14px] font-semibold text-navy-600">Area E: Physical Environment &amp; Safety</h2>
            </div>
          </div>
          <div class="p-6 space-y-3">
            <h3 class="text-[12px] font-semibold text-navy-600 flex items-center gap-2"><i
            ...
            <div class="grid grid-cols-1 gap-2">
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Fenced by non-climbable barrier or natural barriers <span
                    class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
            ...
            <div class="grid grid-cols-1 gap-2">
              ...
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">At least 1 toilet/bath &amp; 1 lavatory (child-sized) <span
                    class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Child-sized furniture (tables, chairs, shelves) <span
                    class="score-badge bg-navy-100 text-navy-600 ml-2">1 pt</span></span></label>
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
            ...
            <div class="grid grid-cols-1 gap-2">
              ...
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Outdoor area fenced &amp; in clear view of staff <span
                    class="score-badge bg-navy-400 text-white ml-2">2 pts</span></span></label>
              <label
                class="check-item flex items-center gap-3 p-2.5 border-2 border-slate-200 rounded-xl cursor-pointer"><input
                  type="checkbox" class="w-4 h-4 accent-navy-600 flex-shrink-0"><span
                  class="text-[12px] text-slate-700">Outdoor structures firmly anchored &amp; safe <span
                    class="score-badge bg-navy-400 text-white ml-2">2 pts</span></span></label>
            </div>
          </div>
        </div>
        ...
        <div class="animate-fade-up-4 bg-white rounded-2xl border border-slate-200 overflow-hidden">
          ...
          <div class="p-6">
            <div class="overflow-x-auto">
              <table class="w-full text-[12px] border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                  <tr>
                    <td class="px-3 py-2 font-medium text-navy-600">A. Children's Growth &amp; Development</td>
                  ...
                  <tr>
                    <td class="px-3 py-2 font-medium text-navy-600">B. Partnership with Families</td>
                    <td class="px-3 py-2 text-center"><input type="number" min="0"
                        class="w-16 py-1 px-2 border border-slate-200 rounded-lg text-center text-[12px]"
                        placeholder="0"></td>
                    <td class="px-3 py-2 text-center"><input type="number" min="0"
                  ...
                  <tr>
                    <td class="px-3 py-2 font-medium text-navy-600">C. Human Resource Development</td>
                    <td class="px-3 py-2 text-center"><input type="number" min="0"
                        class="w-16 py-1 px-2 border border-slate-200 rounded-lg text-center text-[12px]"
                        placeholder="0"></td>
                    <td class="px-3 py-2 text-center"><input type="number" min="0"
                  ...
                  <tr>
                    <td class="px-3 py-2 font-medium text-navy-600">E. Physical Environment &amp; Safety</td>
                    <td class="px-3 py-2 text-center"><input type="number" min="0"
                        class="w-16 py-1 px-2 border border-slate-200 rounded-lg text-center text-[12px]"
                        placeholder="0"></td>
                    <td class="px-3 py-2 text-center"><input type="number" min="0"
            ...
            <p class="text-[10px] text-slate-400 mt-3">
              <strong>Level 1 (3 Stars):</strong> Min 97 pts · <strong>Level 2 (4 Stars):</strong> Level 1 + min 30 pts
        ...
        <div class="animate-fade-up-4 bg-white rounded-2xl border border-slate-200 overflow-hidden">
          ...
          <div class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div><label class="field-label">Validity Period (years)</label><input type="number" min="0" max="5"
                  class="field" placeholder="3, 4, or 5"></div>
              <div><label class="field-label">Compliance Period (months)</label><input type="number" min="0" max="6"
                  class="field" placeholder="If pending"></div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div><label class="field-label">Assessed By (DSWD Accreditor)</label><input type="text" class="field"
                  placeholder="Name & Signature"></div>
              <div><label class="field-label">Date</label><input type="date" class="field"></div>
            </div>
            <div class="grid grid-cols-2 gap-4">
              <div><label class="field-label">Concurred By (DCW/Agency Head)</label><input type="text" class="field"
                  placeholder="Name & Signature"></div>
              <div><label class="field-label">Date</label><input type="date" class="field"></div>
            </div>
