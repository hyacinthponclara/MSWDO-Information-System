...
// Format birthdate
$rawBirthdate = $client['cl_birthdate'] ?? '';
$formattedBirthdate = !empty($rawBirthdate) ? date('F j, Y', strtotime($rawBirthdate)) : '';
...
<head>
    ...
    <style>
        ...
        #caseSummaryView .summary-family-table tbody tr:last-child td {
            border-bottom: none;
        }

        #caseSummaryView .summary-family-table tbody tr:hover {
            background: #FAFDFC;
        }

        #caseSummaryView .summary-family-table .client-row {
            background: #F0FDF4;
        }
        ...
        #caseSummaryView .summary-money-card.income {
            background: #F0FDF4;
            border: 1px solid #BBF7D0;
        }

        #caseSummaryView .summary-money-card.expense {
            background: #FFF7F7;
            border: 1px solid #FECACA;
        }

        #caseSummaryView .summary-money-card.net {
            background: #F4F7FC;
        ...
        #caseSummaryView .summary-ledger-row:last-child {
            border-bottom: none;
        }

        #caseSummaryView .summary-ledger-label {
            flex: 1;
            color: #475569;
        }

        #caseSummaryView .summary-ledger-value {
            font-weight: 600;
            color: #166534;
        }

        #caseSummaryView .summary-expense-value {
            color: #dc2626;
        }
        ...
        #caseSummaryView .formal-logo.left {
            left: 0;
            top:
        }

        #caseSummaryView .formal-logo.right {
            right: 0;
        }
        ...
        #caseSummaryView .formal-family-table th:nth-child(1) {
            width: 5%;
        }

        #caseSummaryView .formal-family-table th:nth-child(2) {
            width: 28%;
        }

        #caseSummaryView .formal-family-table th:nth-child(3) {
            width: 10%;
        }

        #caseSummaryView .formal-family-table th:nth-child(4) {
            width: 23%;
        }

        #caseSummaryView .formal-family-table th:nth-child(5) {
            width: 22%;
        }

        #caseSummaryView .formal-family-table th:nth-child(6) {
            width: 12%;
        }
...
<body class="bg-slate2 min-h-screen flex">
                    ...
                    <form id="caseStudyForm" method="POST" action="casestudy.php?client_id=<?= (int) $client_id ?>">
                        ...
                        <div class="section-card animate-fade-up-1">
                            <div class="section-head">
                                ...
                                <div>
                                    ...
                                    <p class="text-[11px] text-slate-400">Basic information about this case study
                                        interview
                                    </p>
                                </div>
                            </div>
                            <div class="section-body">
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="text-[13px] font-semibold text-slate-700">Patient is different from
                                            client
                                            / claimant</p>
                                        <p class="text-[11px] text-slate-400 mt-0.5">Enable if the person being assisted
                                            is
                                            not the registered client</p>
                                    </div>
                                    <label class="relative cursor-pointer flex items-center gap-3">
                                        <input type="checkbox" id="patientDiff" class="sr-only"
                                ...
                                <div id="patientInfoFields" class="hidden mt-4 grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" class="field" name="patient_name" oninput="updateAllTexts()">
                                    </div>
                                    <div>
                                        <label class="field-label">Relationship to Client</label>
                                        <input type="text" class="field" name="patient_relationship"
                                            placeholder="e.g. Child, Spouse, Parent" oninput="updateAllTexts()">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section-card animate-fade-up-2">
                            <div class="section-head">
                                ...
                                <div>
                                    <h2 class="text-[14px] font-semibold text-mswdo-600">IDENTIFYING DATA</h2>
                                    <p class="text-[11px] text-slate-400">Client personal information</p>
                                </div>
                            </div>
                            <div class="section-body grid grid-cols-2 gap-4">
                                <div>
                                    <label class="field-label">Name</label>
                                    <input type="text" class="field" id="id_name" value="<?= $full_name ?>" readonly>
                                </div>
                                <div>
                                    <label class="field-label">Age</label>
                                    <input type="text" class="field" id="id_age" value="<?= $age ?>" readonly>
                                </div>
                                <div>
                                    <label class="field-label">Sex</label>
                                    <input type="text" class="field" id="id_sex" value="<?= $sex ?>" readonly>
                                </div>
                                <div>
                                    <label class="field-label">Date of Birth</label>
                                    <input type="text" class="field" id="id_dob"
                                        value="<?= htmlspecialchars($formattedBirthdate) ?>" readonly>
                                </div>
                                <div>
                                    <label class="field-label">Address</label>
                                    <input type="text" class="field" id="id_address" value="<?= $barangay ?>" readonly>
                                </div>
                                <div>
                                    <label class="field-label">Nearest Kin</label>
                                    <input type="text" class="field" name="nearest_kin" id="id_nearest_kin"
                                        placeholder="Enter nearest kin" oninput="updateAllTexts()">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section-card animate-fade-up-3">
                            ...
                            <div class="section-body">
                                ...
                                <div class="flex items-center justify-end mt-3 gap-4 text-[12px]">
                                    ...
                                    <span id="totalIncome" class="font-bold text-mswdo-600 text-[14px]">₱0.00</span>
                                </div>
                        ...
                        <!--  Section 4: Income & Financial Resources  -->
                        <div class="section-card animate-fade-up-4">
                            <div class="section-head">
                                <div class="section-num">4</div>
                                <div>
                                    <h2 class="text-[14px] font-semibold text-mswdo-600">Income & Financial Resources
                                    </h2>
                            ...
                            <div class="section-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="ledger-group">
                                            ...
                                            <div class="calc-row">
                                                ...
                                                <div class="relative calc-input">
                                                    <span
                                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[12px]">₱</span>
                                                    <input type="number" id="remittanceInput"
                                                        class="field pl-6 text-[12px] py-2" placeholder="0"
                                                        oninput="calcNet(); updateAllTexts();">
                                                </div>
                                            </div>
                                            <div class="calc-row">
                                                ...
                                                <div class="relative calc-input">
                                                    <span
                                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[12px]">₱</span>
                                                    <input type="number" id="pensionInput"
                                                        class="field pl-6 text-[12px] py-2" placeholder="0"
                                                        oninput="calcNet(); updateAllTexts();">
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-4 space-y-3">
                                            <div>
                                                ...
                                                <input type="text" id="insuranceInput" class="field"
                                                    name="insurance_coverage" placeholder="e.g. PhilHealth only, None"
                                                    oninput="updateAllTexts();">
                                            </div>
                                            <div>
                                                ...
                                                <div class="relative">
                                                    <span
                                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[12px]">₱</span>
                                                    <input type="number" id="savingsInput" class="field pl-6"
                                                        name="savings" placeholder="0" oninput="updateAllTexts();">
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div class="flex gap-2 mt-0.5">
                                                    <label
                                                        ...
                                                        <input type="radio" name="emergency_fund_available" value="1"
                                                            class="hidden" onchange="updateAllTexts();"> Yes
                                                    </label>
                                                    <label
                                                        ...
                                                        <input type="radio" name="emergency_fund_available" value="0"
                                                            class="hidden" checked onchange="updateAllTexts();"> None
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div class="calc-row">
                                                ...
                                                <div class="relative calc-input">
                                                    <span
                                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[12px]">₱</span>
                                                    <input type="number" id="utilitiesInput"
                                                        class="field pl-6 text-[12px] py-2" placeholder="0"
                                                        oninput="calcNet(); updateAllTexts();">
                                                </div>
                                            </div>
                                            <div class="calc-row">
                                                ...
                                                <div class="relative calc-input">
                                                    <span
                                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[12px]">₱</span>
                                                    <input type="number" id="foodInput"
                                                        class="field pl-6 text-[12px] py-2" placeholder="0"
                                                        oninput="calcNet(); updateAllTexts();">
                                                </div>
                                            </div>
                                            ...
                                            <div class="calc-row">
                                                ...
                                                <div class="relative calc-input">
                                                    <span
                                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[12px]">₱</span>
                                                    <input type="number" id="medicationInput"
                                                        class="field pl-6 text-[12px] py-2" placeholder="0"
                                                        oninput="calcNet(); updateAllTexts();">
                                                </div>
                                            </div>
                                ...
                                <div class="mt-5 grid grid-cols-3 gap-3">
                                    <div
                                        class="bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3 text-center">
                                        <p
                                            class="text-[10px] uppercase tracking-wide text-emerald-600 font-semibold mb-1">
                                            Total Income</p>
                                    ...
                                    <div class="bg-red-50 border border-red-200 rounded-xl px-4 py-3 text-center">
                                        <p class="text-[10px] uppercase tracking-wide text-red-500 font-semibold mb-1">
                                            Total
                                            Expenses</p>
                                    ...
                                    <div class="bg-navy-50 border border-navy-100 rounded-xl px-4 py-3 text-center">
                                        <p class="text-[10px] uppercase tracking-wide text-navy-500 font-semibold mb-1">
                                            Net
                                            Monthly</p>
                        ...
                        <div class="section-card animate-fade-up-5">
                            <div class="section-head">
                                ...
                                <div>
                                    <h2 class="text-[14px] font-semibold text-mswdo-600">Problem Presented</h2>
                                    <p class="text-[11px] text-slate-400">Auto-generated from client and case details –
                                        edit as needed</p>
                                </div>
                            </div>
                            <div class="section-body">
                        ...
                        <!--  Section 6: Home and Economic Condition  -->
                        <div class="section-card animate-fade-up-6">
                            <div class="section-head">
                                <div class="section-num">6</div>
                                <div>
                                    <h2 class="text-[14px] font-semibold text-mswdo-600">Home and Economic Condition
                                    </h2>
                                    <p class="text-[11px] text-slate-400">Auto-generated from client data – edit as
                                        needed</p>
                                </div>
                            </div>
                            <div class="section-body">
                                <div>
                                    ...
                                    <textarea class="field" rows="6" name="home_condition" id="homeText" maxlength="800"
                        ...
                        <!--  Section 7: Indigency Assessment  -->
                        ...
                        <!--  Section 8: Previous DSWD Assistance  -->
                        <div class="section-card animate-fade-up-8">
                            <div class="section-head">
                        ...
                        <!--  Section 9: Evaluation & Recommendation  -->
                        <div class="section-card animate-fade-up-9">
                            <div class="section-head">
                                <div class="section-num">9</div>
                                <div>
                                    <h2 class="text-[14px] font-semibold text-navy-600">Evaluation & Recommendation</h2>
                                    <p class="text-[11px] text-slate-400">Auto-generated from case data – edit as needed
                                    </p>
                                </div>
                            </div>
                            <div class="section-body space-y-4">
                                <div>
                                    ...
                                    <textarea class="field" rows="5" name="recommendation" id="recoText"
                                        maxlength="1200" oninput="countChars('recoText','recoCount',1200)"
                    ...
                    <article class="formal-paper" id="formalCaseSummary">
                        ...
                        <section class="formal-section">
                            ...
                            <div class="formal-identifying">
                                ...
                                <div id="formalName" class="value">—</div>
                                <div class="label">Age</div>
                                <div id="formalAge" class="value">—</div>
                                <div class="label">Sex</div>
                                <div id="formalSex" class="value">—</div>
                                <div class="label">Date of Birth</div>
                                <div id="formalDOB" class="value">—</div>
                                <div class="label">Address</div>
                                <div id="formalAddress" class="value">—</div>
                                <div class="label">Nearest Kin</div>
                                <div id="formalNearestKin" class="value">—</div>
                            </div>
                        </section>
                        ...
                        <div class="formal-signatory">
                            ...
                            <div id="formalLicenseValidity" class="role">Valid until August 2028</div>
                        </div>
                    </article>
    ...
    <script>
        ...
        // Helper: get total family income from the family table rows
        function getFamilyTotalIncome() {
            let total = 0;
            const rows = document.querySelectorAll('#famBody tr.fam-row');
            rows.forEach(row => {
                const cells = row.querySelectorAll('td');
                if (cells.length >= 9) {
                    const incomeStr = cells[8].textContent.replace(/[₱,]/g, '').trim();
        ...
        // Helper: get client occupation from family table first row (client row)
        function getClientOccupation() {
            const rows = document.querySelectorAll('#famBody tr.fam-row');
            if (rows.length > 0) {
        ...
        // Helper: get client sex (from identifying data)
        function getClientSex() {
            const sexField = document.getElementById('id_sex');
            return sexField ? sexField.value.trim() : '';
        }
        ...
        function getClientAddress() {
            const addrField = document.getElementById('id_address');
            return addrField ? addrField.value.trim() : '';
        }

        // Helper: get client date of birth (formatted)
        function getClientDOB() {
            const dobField = document.getElementById('id_dob');
            return dobField ? dobField.value.trim() : '';
        }

        // Helper: get nearest kin
        function getNearestKin() {
            const kinField = document.getElementById('id_nearest_kin');
            return kinField ? kinField.value.trim() : '';
        }

        // Helper: get type of case study
        function getCaseType() {
            const sel = document.querySelector('[name="type_of_case_study"]');
            return sel ? sel.value : '';
        }

        // Helper: get patient relationship
        function getPatientRelation() {
            const relField = document.querySelector('[name="patient_relationship"]');
            return relField ? relField.value.trim() : '';
        }

        // Helper: get indigency assessment
        function getIndigency() {
            const val = document.getElementById('indigValue');
            return val ? val.value : 'Not Assessed';
        }

        // Helper: get pronoun based on sex
        ...
        // Helper: get subject pronoun (he/she)
        function getSubjectPronoun(sex) {
            sex = sex.toLowerCase();
        ...
        // Main function to update all auto-generated text fields
        function updateAllTexts() {
            const clientName = getClientName();
            const sex = getClientSex();
            const subject = getSubjectPronoun(sex);
            const possessive = getPronoun(sex);
            const address = getClientAddress();
            const occupation = getClientOccupation() || '—';
            const combinedIncome = getFamilyTotalIncome();
            const caseType = getCaseType() || 'Assistance';
            const relation = getPatientRelation();
            const indigency = getIndigency();

            // Read financial data for dynamic parts
            const remittance = parseFloat(document.getElementById('remittanceInput')?.value) || 0;
            const pension = parseFloat(document.getElementById('pensionInput')?.value) || 0;
            const otherIncome = parseFloat(document.getElementById('otherIncomeInput')?.value) || 0;

            // Total income and expenses for sufficiency
            const totalIncome = combinedIncome + remittance + pension + otherIncome;
            ...
            const medication = parseFloat(document.getElementById('medicationInput')?.value) || 0;
            const debt = parseFloat(document.getElementById('debtInput')?.value) || 0;
            const totalExpenses = utilities + food + rent + medication + debt;
            const net = totalIncome - totalExpenses;

            let incomeStatus = 'sufficient';
            if (net < 0) incomeStatus = 'not enough';
            else if (net < 2000) incomeStatus = 'barely enough';

            // Build other income sources string
            let otherSources = [];
            if (remittance > 0) otherSources.push('remittance');
            if (pension > 0) otherSources.push('pension');
            if (otherIncome > 0) otherSources.push('other income');
            let otherSourcesText = '';
            if (otherSources.length > 0) {
                otherSourcesText = 'Aside from her regular income, she also receives ' + otherSources.join(', ') + '.';
            } else {
                otherSourcesText = 'The client has no other source of income.';
            }

            // --- HOME AND ECONOMIC CONDITION ---
            let homeText = `The client, ${clientName} of legal age, and a bona fide resident of ${address}. The client works as a ${occupation} with a combined income of ₱${combinedIncome.toFixed(2)}. `;
            homeText += `Her monthly income is ${incomeStatus} for their daily living. `;
            homeText += otherSourcesText + ' ';
            // Use the fixed text as requested:
            homeText += `Financially, ${subject} is struggling to provide and has nothing more to spare`;
            if (relation) {
                homeText += ` for all the medical expenses of ${possessive} ${relation}`;
            }
            homeText += `. All means have been exhausted already. ${capitalize(subject)} has no savings. ${capitalize(subject)} has no insurance coverage. ${capitalize(subject)} has no emergency fund.`;

            const homeField = document.getElementById('homeText');
            if (homeField) {
                homeField.value = homeText;
                countChars('homeText', 'homeCount', 800);
            }

            // --- PROBLEM PRESENTED ---
            let problemText = `The client, ${clientName}, is in need of immediate ${caseType} Assistance`;
            if (relation) {
                problemText += ` for ${possessive} ${relation} needs.`;
            } else {
                problemText += `.`;
            }
            const problemField = document.getElementById('problemText');
            if (problemField) {
                problemField.value = problemText;
                countChars('problemText', 'problemCount', 1000);
            }

            // --- EVALUATION / RECOMMENDATION ---
            let recoText = `This is the case of ${clientName}, who is of legal age, who needs ${caseType} Assistance`;
            if (relation) {
                recoText += ` for ${possessive} ${relation}'s ${caseType} needs. The client did find ways and means to meet ${possessive} ${relation}'s ${caseType} needs, but it is still not enough.`;
            } else {
                recoText += `. The client did find ways and means to meet ${possessive} ${caseType} needs, but it is still not enough.`;
            }
            recoText += ` Based on the information stated above, I therefore respectfully recommend that this client is ${indigency} and needs ${caseType} Assistance from the SWAD OFFICE, to defray for ${possessive}`;
            if (relation) {
                recoText += ` ${relation}'s ${caseType} expenses.`;
            } else {
                recoText += ` ${caseType} expenses.`;
            }
            const recoField = document.getElementById('recoText');
            if (recoField) {
                recoField.value = recoText;
                countChars('recoText', 'recoCount', 1200);
            }

            // Update hidden income for DB
            const hiddenIncome = document.getElementById('hiddenIncome');
            if (hiddenIncome) hiddenIncome.value = totalIncome;
        }
        ...
        function getFormalClientData() {
            ...
            return {
                name: getClientName() || cells[1] || '—',
                age: getClientAge() || cells[3] || '—',
                sex: getClientSex() || cells[4] || '—',
                dob: getClientDOB(),
                address: getClientAddress() || '—',
                nearestKin: getNearestKin() || '—'
            };
        }

        function getClientAge() {
            const ageField = document.getElementById('id_age');
            return ageField ? ageField.value.trim() : '';
        }
        ...
        function renderFormalCaseSummary() {
            ...
            setFormalText('formalDOB', client.dob);
            setFormalText('formalAddress', client.address);
            setFormalText('formalNearestKin', client.nearestKin);
            ...
            setFormalText('formalLicenseValidity', 'Valid until August 2028');

            document.getElementById('caseSummaryStatus').textContent =
                'Reviewing the current case-study values. Click Submit to store them in the database.';
        }
        ...
        function getCaseStudyDataForFinalPDF() {
            ...
            return {
                client: {
                    fullName: getClientName() || bannerPs[0]?.textContent.trim() || '',
                    age: getClientAge() || '',
                    sex: getClientSex() || '',
                    dateOfBirth: getClientDOB(),
                    address: getClientAddress() || bannerParts[1] || '',
                    nearestKin: getNearestKin() || ''
                },
                interview: {
                    date: document.querySelector('[name="interview_date"]')?.value ? formatSummaryDate(document.querySelector('[name="interview_date"]').value) : '',
                    type: document.querySelector('[name="type_of_case_study"]')?.value || ''
                },
                patient: {
                    fullName: document.querySelector('[name="patient_name"]')?.value || '',
                    relation: document.querySelector('[name="patient_relationship"]')?.value || ''
                },
                family,
                finances: {
                    insurance: document.querySelector('[name="insurance_coverage"]')?.value || '',
                    savings: document.querySelector('[name="savings"]')?.value || '',
                    emergencyFund: document.querySelector('[name="emergency_fund_available"]')?.value || ''
                },
                assessment: {
                    problemPresented: document.querySelector('[name="problem_presented"]')?.value || '',
                    homeCondition: document.querySelector('[name="home_condition"]')?.value || '',
                    indigency: document.querySelector('[name="indigency_assessment"]')?.value || ''
                },
                recommendation: document.querySelector('[name="recommendation"]')?.value || '',
                submitted: { preparedBy: 'MA. TERESA C. PONCLARA, RSW', designation: 'MSWDO', prcLicense: '0011198', licenseValidity: 'August 2028' }
            };
        }
        ...
        async function previewCaseSummaryPDF(openInNewTab = true) {
            ...
            if (openInNewTab) {
                ...
                if (!previewWindow) {
                    alert('Please allow pop-ups for this page to view the Case Summary PDF.');
                    return;
                }
            }
        ...
        <html>
        <head>
            <title>Preparing Case Summary...</title>
            <style>
                body { margin:0; min-height:100vh; display:flex; align-items:center; justify-content:center; background:#f4f7f5; font-family:Arial, sans-serif; color:#14532d; }
                .box { text-align:center; background:white; border:1px solid #d7e4da; border-radius:16px; padding:32px 42px; box-shadow:0 10px 30px rgba(20,83,45,.08); }
                .spin { width:32px; height:32px; border:3px solid #dcfce7; border-top-color:#15803d; border-radius:50%; margin:0 auto 16px; animation:spin 1s linear infinite; }
        ...
        <body>
            <div class="box">
                <div class="spin"></div>
                <strong>Preparing Case Summary...</strong>
                <p>Your official PDF preview is being generated.</p>
            </div>
        </body>
        </html>
    `);
            ...
            const buttons = document.querySelectorAll('[onclick^="previewCaseSummaryPDF"]');
            ...
            try {
                if (!window.jspdf || !window.jspdf.jsPDF) {
                    throw new Error('PDF library is unavailable. Please refresh the page.');
                }
                const { jsPDF } = window.jspdf;

                const LOGO_LEFT = await imageToSquareDataURL(LOGO_LEFT_PATH);
                const LOGO_RIGHT = await imageToSquareDataURL(LOGO_RIGHT_PATH);
                ...
                const DARK = [20, 20, 20];
                const HEADER_FILL = [232, 240, 234];
                const BORDER = [135, 145, 138];
                ...
                function addWrapped(text, x, width, fontSize = 10.5, lineHeight = 5.1, bold = false) {
                    doc.setFont('helvetica', bold ? 'bold' : 'normal');
                    doc.setFontSize(fontSize);
                    doc.setTextColor(...DARK);
                    const lines = doc.splitTextToSize(safePdf(text), width);
                ...
                try {
                    ...
                    doc.addImage(LOGO_LEFT, 'JPEG', margin + 2, logoY, logoSize, logoSize);
                    doc.addImage(LOGO_RIGHT, 'JPEG', pageW - margin - 2 - logoSize, logoY, logoSize, logoSize);
                } catch (logoError) {
                ...
                doc.setFont('helvetica', 'bold');
                doc.setFontSize(10.5);
                doc.text('Republic of the Philippines', pageW / 2, 11, { align: 'center' });
                doc.text('Province of Negros Occidental', pageW / 2, 16, { align: 'center' });
                doc.text('Municipality of San Enrique', pageW / 2, 21, { align: 'center' });
                doc.setFontSize(11.5);
                doc.text('MUNICIPAL SOCIAL WELFARE AND DEVELOPMENT OFFICE', pageW / 2, 27, { align: 'center' });

                y = 42;
                doc.setFont('helvetica', 'bold');
                doc.setFontSize(11.5);
                doc.text('SOCIAL CASE SUMMARY', pageW / 2, y, { align: 'center' });
                y += 6;
                doc.setFont('helvetica', 'normal');
                doc.setFontSize(9.5);
                doc.text(safePdf(caseStudyData.interview?.date), pageW / 2, y, { align: 'center' });
                y += 11;

                // I. IDENTIFYING DATA
                sectionTitle('I', 'IDENTIFYING DATA');
                const c = caseStudyData.client || {};
                const identifying = [
                    ['Name', safePdf(c.fullName)],
                    ['Age', safePdf(c.age ? c.age + ' YEARS OLD' : '')],
                    ['Sex', safePdf(c.sex)],
                    ['Date of Birth', safePdf(c.dateOfBirth)],
                    ['Address', safePdf(c.address)],
                    ['Nearest Kin', safePdf(c.nearestKin)]
                ];
                identifying.forEach(([label, value]) => {
                    ensureSpace(6);
                    doc.setFont('helvetica', 'bold');
                    doc.setFontSize(10);
                    ...
                    doc.setFont('helvetica', 'normal');
                    const lines = doc.splitTextToSize(value, contentW - 53);
                    doc.text(lines, margin + 52, y);
                    y += Math.max(5.1, lines.length * 4.8);
                });
                y += 5;

                // II. FAMILY COMPOSITION
                sectionTitle('II', 'FAMILY COMPOSITION');
                const family = caseStudyData.family || [];
                const rows = family.map((m, i) => [
                    String(i + 1),
                    safePdf(m.name),
                    safePdf(m.age),
                    safePdf(m.relationship),
                    safePdf(m.education),
                    safePdf(m.occupation)
                ]);

                if (typeof doc.autoTable !== 'function') {
                    throw new Error('AutoTable plugin is not loaded.');
                }
                ...
                doc.autoTable({
                    ...
                    tableWidth: contentW,
                    head: [['', 'NAME', 'AGE', 'RELATION TO CLIENT', 'EDUCATIONAL ATTAINMENT', 'OCCUPATION']],
                ...
                sectionTitle('III', 'PROBLEM PRESENTED');
                addWrapped(caseStudyData.assessment?.problemPresented, margin, contentW, 10.5, 5.1);
                y += 8;

                // IV. HOME AND ECONOMIC CONDITION
                sectionTitle('IV', 'HOME AND ECONOMIC CONDITION');
                addWrapped(caseStudyData.assessment?.homeCondition, margin, contentW, 10.5, 5.1);
                y += 7;

                // V. EVALUATION / RECOMMENDATION
                sectionTitle('V', 'EVALUATION / RECOMMENDATION');
                addWrapped(caseStudyData.recommendation, margin, contentW, 10.5, 5.1);
                y += 13;
                ...
                y += 20;
                doc.setFont('helvetica', 'bold');
                doc.text(safePdf(caseStudyData.submitted?.preparedBy || caseStudyData.submitted?.submittedBy), margin, y);
                y += 5;
                doc.setFont('helvetica', 'normal');
                doc.text(safePdf(caseStudyData.submitted?.designation || 'MSWDO'), margin, y);
                y += 5;
                if (caseStudyData.submitted?.prcLicense) {
                    doc.text('PRC License # ' + caseStudyData.submitted.prcLicense, margin, y);
                    y += 5;
                }
                if (caseStudyData.submitted?.licenseValidity) {
                    doc.text('Valid until ' + caseStudyData.submitted.licenseValidity, margin, y);
                }
                ...
                console.error('Case Summary PDF error:', error);
                if (openInNewTab && previewWindow) {
                    previewWindow.document.body.innerHTML = `
            <div style="font-family:Arial;padding:40px;text-align:center;color:#991b1b;">
                <h3>Unable to create the Case Summary PDF.</h3>
                <p style="color:#64748b;">Please refresh the page and try again.</p>
                <p style="font-size:11px;color:#94a3b8;">${safePdf(error.message || 'Unknown error')}</p>
            </div>
        `;
                } else {
                    const loader = document.getElementById('caseSummaryGenerating');
                ...
                buttons.forEach(button => {
                    ...
                    button.innerHTML = '<i class="fas fa-file-pdf mr-2"></i> View Case Summary';
                });
            }
        }
