...
<head>
    ...
    <title>Day Care Fund Requests – MSWDO San Enrique</title>
...
<body class="bg-slate2 min-h-screen flex">
    ...
    <div class="ml-64 flex-1 flex flex-col min-h-screen">
        ...
        <header
            ...
            <div class="flex items-center gap-2 text-[13px]">
                <span class="text-green-600 font-semibold">Day Care Fund Requests</span>
            </div>
        </header>
        ...
        <main class="flex-1 p-6 space-y-5 overflow-y-auto">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 animate-fade-up">
                <div>
                    <h1 class="text-xl font-serif text-green-600">Day Care Fund Requests</h1>
                    <p class="text-[13px] text-slate-500 mt-0.5">View, filter, and export all day care fund requests.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-5">
                    <div class="flex items-center justify-between mb-3">
                        <h3 class="text-[13px] font-semibold text-green-600"><i
                                class="fas fa-home mr-1.5 text-green-400"></i>Day Care Budget</h3>
    ...
    <script>
        // ── Database Data (day care fund requests) ──
                ...
                tbody.innerHTML = `
                    <tr>
                        <td colspan="10" class="px-5 py-10 text-center text-slate-400">
                            No day care fund requests found for the selected date range.
                        </td>
                    </tr>
                `;
            } else {
        ...
        function exportCSV() {
            ...
            csv += 'Day Care Fund Requests Report\n\n';
            ...
            a.href = url;
            a.download = 'Day Care Center Program_Fund_Requests_' + new Date().toISOString().slice(0, 10) + '.csv';
            a.click();
