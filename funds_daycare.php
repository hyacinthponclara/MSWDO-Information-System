...
<head>
    ...
    <title>Day Care Activity Fund Request – MSWDO San Enrique</title>
...
<body class="bg-slate2 min-h-screen flex">
    ...
    <div class="ml-64 flex-1 flex flex-col min-h-screen">
        <header
            ...
            <div class="flex items-center gap-2 text-[13px]">
                ...
                <span class="text-navy-600 font-semibold">Day Care Activity Fund Request</span>
            </div>
        ...
        <main class="p-6 overflow-y-auto">
            <div class="max-w-3xl mx-auto space-y-5">
                <div class="animate-fade-up">
                    <h1 class="text-xl font-serif text-navy-600">Day Care Activity Fund Request</h1>
                    <p class="text-[13px] text-slate-500 mt-1">Request funds for day care center events and
                        improvements.</p>
                </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div><label class="field-label req">Name of Event / Activity</label><input type="text"
                                    class="field" id="eventName" placeholder="e.g. Nutrition Month Celebration"></div>
                        ...
                        <div class="bg-slate-50 border border-slate-200 rounded-xl overflow-hidden" id="limitPanel">
                            <div
                                ...
                                <p class="text-[11px] font-semibold text-navy-600">Automatic Budget Check — Day Care
                                    Activity Fund</p>
                            ...
                            <div id="limitRows" class="divide-y divide-slate-100">
                                <div class="limit-row flex items-center justify-between px-4 py-2.5">
                                    ...
                                    <span class="text-[12px] font-semibold text-navy-600">₱111,000 available</span>
                                </div>
    ...
    <script>
        const totalBudget = 300000, spent = 189000, remaining = totalBudget - spent, pctUsed = 63;
        ...
        function saveComplete() {
            ...
            showToast('Day care activity fund request submitted ✓');
        }
    </script>
</body>
