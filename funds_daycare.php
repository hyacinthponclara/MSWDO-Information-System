...
<body class="bg-slate2 min-h-screen flex">
        ...
        <main class="flex-1 p-6 space-y-5 overflow-y-auto">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 animate-fade-up">
                <div>
                    ...
                    <p class="text-[13px] text-slate-500 mt-0.5">View, filter, and export all Day Care Center fund requests.</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-4 animate-fade-up-1">
                <div class="bg-white rounded-2xl border border-slate-200 p-5">
                    <div class="flex items-center justify-between mb-3">
                        <h3 class="text-[13px] font-semibold text-green-600"><i class="fas fa-school mr-1.5 text-green-400"></i>Day Care Budget</h3>
    ...
    <script>
        ...
        function exportCSV() {
            ...
            a.href = url;
            a.download = 'Day_Care_Fund_Requests_' + new Date().toISOString().slice(0, 10) + '.csv';
            a.click();
