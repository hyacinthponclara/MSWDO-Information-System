...
<head>
    ...
    <title>Solo Parent Activity Fund Request – MSWDO San Enrique</title>
...
<body class="bg-slate2 min-h-screen flex">
        ...
        <main class="p-6 overflow-y-auto">
            <div class="max-w-3xl mx-auto space-y-5">
                <div class="animate-fade-up">
                    ...
                    <p class="text-[13px] text-slate-500 mt-1">Request funds for solo parent events and programs.</p>
                </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div><label class="field-label req">Name of Event / Activity</label><input type="text"
                                    class="field" id="eventName" placeholder="e.g. Solo Parent Activity"></div>
                        ...
                        <div class="bg-slate-50 border border-slate-200 rounded-xl overflow-hidden" id="limitPanel">
                            ...
                            <div id="limitRows" class="divide-y divide-slate-100">
                                <div class="limit-row flex items-center justify-between px-4 py-2.5">
                                    ...
                                    <span class="text-[12px] font-semibold text-navy-600">₱86,800 available</span>
                                </div>
    ...
    <script>
        const totalBudget = 160000, spent = 73200, remaining = totalBudget - spent, pctUsed = 46;
        ...
        function saveComplete() {
            ...
            showToast('Solo parent activity fund request submitted ✓');
        }
    </script>
</body>
