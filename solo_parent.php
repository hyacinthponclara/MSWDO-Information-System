...
<head>
    ...
    <title>Solo Parent – MSWDO San Enrique</title>
...
<body class="bg-slate2 min-h-screen flex">
    ...
    <div class="ml-64 flex-1 flex flex-col min-h-screen">
        <header
            ...
            <div class="flex items-center gap-2 text-[13px]">
                ...
                <span class="text-navy-600 font-semibold">Solo Parent Availment</span>
            </div>
        ...
        <main class="p-6 overflow-y-auto">
            <div class="max-w-3xl mx-auto space-y-5">
                <div class="animate-fade-up">
                    <h1 class="text-xl font-serif text-navy-600">Solo Parent ID (SPID) Issuance</h1>
                    <p class="text-[13px] text-slate-500 mt-1">Record the issuance of a Solo Parent ID under RA 8972.
                    </p>
                </div>
                ...
                <div class="animate-fade-up-2 bg-white rounded-2xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-3 gap-4">
                            <div><label class="field-label">SPID Number</label><input type="text" class="field"
                                    placeholder="SPID-XXXX-XXXX"></div>
                            <div><label class="field-label">Date Issued</label><input type="date" class="field"></div>
                            <div><label class="field-label req">Solo Parent Category</label>
                                <select class="field">
                                    <option value="">Select</option>
                                    <option>Widow / Widower</option>
                                    <option>OFW Spouse</option>
                                    <option>Abandoned</option>
                                    <option>Unmarried</option>
                                    <option>Legally Separated</option>
                                    <option>Incapacitated Spouse</option>
                                    <option>Other</option>
                                </select>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div><label class="field-label">Organization Name</label><input type="text" class="field"
                                    placeholder="If member of a solo parent org"></div>
                            <div><label class="field-label">Number of Dependents</label><input type="number" min="1"
                                    class="field" placeholder="e.g. 2"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="animate-fade-up-3 bg-white rounded-2xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="bg-navy-50 border border-navy-100 rounded-xl px-4 py-3 flex items-start gap-3 mb-4">
                            <i class="fas fa-info-circle text-navy-500 text-lg mt-0.5"></i>
                            <p class="text-[12px] text-navy-700">Documents vary by category. OFW spouses require
                                additional employment and passport documents.</p>
                        </div>
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <div class="field-label flex items-center text-[10px]">Birth Certs of Children <span
                                        class="copy-badge">1 orig + 2 copies each</span></div><label class="upload-zone"
                                    id="uz-sp-bc"><input type="file" multiple onchange="fileSelected(this,'uz-sp-bc')">
                                    <div class="upload-content"><i class="fas fa-file-alt text-2xl mb-1"></i>
                                        <p class="text-[12px] font-medium text-slate-600">Click to upload (multiple OK)
                                        </p>
                                    </div>
                                </label>
                            </div>
                            <div>
                                <div class="field-label flex items-center text-[10px]">Sworn Affidavit of Sole Parental
                                    Care <span class="copy-badge">Notarized</span></div><label class="upload-zone"
                                    id="uz-sp-affidavit"><input type="file"
                                        onchange="fileSelected(this,'uz-sp-affidavit')">
                            ...
                            <div>
                                <div class="field-label flex items-center text-[10px]">Barangay Affidavit of Residency
                                    <span class="copy-badge">Required</span></div><label class="upload-zone"
                                    id="uz-sp-res"><input type="file" onchange="fileSelected(this,'uz-sp-res')">
                            ...
                            <div>
                                <div class="field-label flex items-center text-[10px]">Solo Parent Orientation
                                    Certificate <span class="copy-badge">Required</span></div><label class="upload-zone"
                                    id="uz-sp-orient"><input type="file" onchange="fileSelected(this,'uz-sp-orient')">
                                    <div class="upload-content"><i class="fas fa-graduation-cap text-2xl mb-1"></i>
                                        <p class="text-[12px] font-medium text-slate-600">Click to upload</p>
                                    </div>
                                </label>
                            </div>
                            <div>
                                <div class="field-label flex items-center text-[10px]">Marriage Contract / Proof of
                                    Relationship <span class="opt-badge">OFW category</span></div><label
                                    class="upload-zone" id="uz-sp-marr"><input type="file"
                                        onchange="fileSelected(this,'uz-sp-marr')">
                            ...
                            <div>
                                <div class="field-label flex items-center text-[10px]">POEA Standard Employment Contract
                                    <span class="opt-badge">OFW only</span></div><label class="upload-zone"
                                    id="uz-sp-poea"><input type="file" onchange="fileSelected(this,'uz-sp-poea')">
                                    <div class="upload-content"><i class="fas fa-file-contract text-2xl mb-1"></i>
                                        <p class="text-[12px] font-medium text-slate-600">Click to upload</p>
                                    </div>
                                </label>
                            </div>
                            <div>
                                <div class="field-label flex items-center text-[10px]">Passport (12‑month work stamps)
                                    <span class="opt-badge">OFW only</span></div><label class="upload-zone"
                                    id="uz-sp-passport"><input type="file"
                                        onchange="fileSelected(this,'uz-sp-passport')">
                                    <div class="upload-content"><i class="fas fa-passport text-2xl mb-1"></i>
                                        <p class="text-[12px] font-medium text-slate-600">Click to upload</p>
                                    </div>
                                </label>
                            </div>
                            <div>
                                <div class="field-label flex items-center text-[10px]">Valid ID of Claimant <span
                                        class="copy-badge">1 orig + 2 copies</span></div><label class="upload-zone"
                                    id="uz-sp-id"><input type="file" onchange="fileSelected(this,'uz-sp-id')">
    ...
    <script>
        ...
        function saveComplete() { showToast('SPID record submitted ✓'); }
    </script>
</body>
