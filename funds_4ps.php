...
<body class="bg-slate2 min-h-screen flex">
        ...
        <main class="p-6 overflow-y-auto">
            <div class="max-w-3xl mx-auto space-y-5">
                <div class="animate-fade-up">
                    ...
                    <p class="text-[13px] text-slate-500 mt-1">Request funds for 4Ps events and activities (Christmas
                        Party, Family Development Session, etc.).</p>
                </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div><label class="field-label req">Name of Event / Activity</label><input type="text"
                                    class="field" id="eventName" placeholder="e.g. Christmas Party 2025"></div>
                        ...
                        <div class="bg-slate-50 border border-slate-200 rounded-xl overflow-hidden" id="limitPanel">
                            <div
                                ...
                                <p class="text-[11px] font-semibold text-navy-600">Automatic Budget Check — 4Ps Activity
                                    Fund</p>
                            ...
                            <div id="limitRows" class="divide-y divide-slate-100">
                                <div class="limit-row flex items-center justify-between px-4 py-2.5">
                                    ...
                                    <span class="text-[12px] font-semibold text-navy-600">₱71,500 available</span>
                                </div>
                ...
                <div class="animate-fade-up-3 bg-white rounded-2xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <label class="upload-zone" id="uz-proposal"><input type="file"
                        ...
                        <div>
                            ...
                            <label class="upload-zone" id="uz-id"><input type="file"
                        ...
                        <div>
                            ...
                            <label class="upload-zone" id="uz-indigency"><input type="file"
                        ...
                        <div>
                            ...
                            <label class="upload-zone" id="uz-residency"><input type="file"
    ...
    <script>
        ...
        requestAnimationFrame(() => setTimeout(() => {
            document.querySelector('.budget-bar-fill').style.width = pctUsed + '%';
        }, 300));
        ...
        function saveComplete() {
            ...
            showToast('4Ps activity fund request submitted ✓');
        }
    </script>
</body>
