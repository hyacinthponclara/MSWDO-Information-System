...
// add up all released amounts for total assistance
$totalAssistance = 0;
  ...
  <div class="ml-64 flex-1 flex flex-col min-h-screen">
    ...
    <header class="bg-white border-b border-slate-200 h-14 flex items-center justify-between px-6 sticky top-0 z-20">
      ...
      <div class="flex items-center gap-2">
        ...
        <a href="newavailment.php?client_id=<?= $client_id ?>"
                  ...
                  <?php else: ?>
                    <?php foreach ($availments as $av): ?>
                      <?php
                        ...
                        $tag = $progColors[$av['program_name']] ?? 'bg-slate-100 text-slate-600';
                      ?>
                      <tr class="table-row">
                        ...
                        <td class="px-5 py-3">
                          <span class="<?= $tag ?> px-2.5 py-0.5 rounded text-[10px] font-semibold">
                            <?= htmlspecialchars($av['program_name'] ?? '—') ?>
                          </span>
                        </td>
