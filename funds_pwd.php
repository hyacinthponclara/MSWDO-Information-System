...
<head>
    ...
    <title>PWD Activity Fund Request – MSWDO San Enrique</title>
...
<body class="bg-slate2 min-h-screen flex">
        ...
        <main class="p-6 overflow-y-auto">
            <div class="max-w-3xl mx-auto space-y-5">
                <div class="animate-fade-up">
                    ...
                    <p class="text-[13px] text-slate-500 mt-1">Request funds for PWD events and programs.</p>
                </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div><label class="field-label req">Name of Event / Activity</label><input type="text"
                                    class="field" id="eventName" placeholder="e.g. PWD Awareness Seminar"></div>
                        ...
                        <div class="bg-slate-50 border border-slate-200 rounded-xl overflow-hidden" id="limitPanel">
                            <div
                                ...
                                <p class="text-[11px] font-semibold text-navy-600">Automatic Budget Check — PWD Activity
                                    Fund</p>
                            ...
                            <div id="limitRows" class="divide-y divide-slate-100">
                                <div class="limit-row flex items-center justify-between px-4 py-2.5">
                                    ...
                                    <span class="text-[12px] font-semibold text-navy-600">₱75,500 available</span>
                                </div>
    ...
    <script>
        const totalBudget = 210000, spent = 134500, remaining = totalBudget - spent, pctUsed = 64;
        ...
        function saveComplete() {
            ...
            showToast('PWD activity fund request submitted ✓');
        }
    </script>
</body>
